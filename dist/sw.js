'use strict';
const CACHE='astra-shell-v4';
const ASSETS=['./','./index.html','./style.css','./extras.css','./aidm-port.css','./engine.js','./state-validation.js','./world.js','./extras.js','./aidm-port.js','./podcast-player.js','./classic.html','./app.js','./manifest.webmanifest','./icon.svg'];
