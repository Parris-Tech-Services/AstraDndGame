...
const ASSETS=['./','./index.html','./style.css','./extras.css','./aidm-port.css','./engine.js','./state-validation.js','./world.js','./extras.js','./aidm-port.js','./classic.html','./app.js','./manifest.webmanifest','./icon.svg'];
