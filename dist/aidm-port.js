...
(()=>{
  ...
  const windowStyles=document.createElement('link');windowStyles.rel='stylesheet';windowStyles.href='window-manager.css';document.head.append(windowStyles);
  const mobileWindowStyles=document.createElement('link');mobileWindowStyles.rel='stylesheet';mobileWindowStyles.href='window-manager-mobile.css';document.head.append(mobileWindowStyles);
  const windowManager=document.createElement('script');windowManager.src='window-manager.js';document.head.append(windowManager);
})();
